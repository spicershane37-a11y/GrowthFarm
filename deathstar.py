...
def main():
    ...
    # -------- Compose full layout --------
    # Positioning knobs for the scoreboards (tweak to taste)
    SB_LEFT_PAD =  (500, 0)   # push to the right so they begin near the end of the tab row (right of "Customers")
    SB_TOP_PAD  =  (0, 6)     # nudge downward so bottoms sit just above the sheet

    # Scoreboards row: a single Column holding both frames, padded left/right & down
    scoreboards_row = [
        sg.Column(
